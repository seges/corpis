 ...
 * implemented methods required by {@link java.util.List} interface.
 *
 * @param <E> Type of list
 *
 * @author eldzi
 */
public abstract class AbstractPagedDTOList<E> implements List<E> {
	protected int defaultPageSize = 10;
	protected PagedResultDTO<List<E>> pagedResult;
	 ...
	 */
	public final PageDTO getCurrentPage() {
	 ...
	 */
	public static int getCurrentPageNumber(PageDTO page) {
	...
	protected abstract PagedResultDTO<List<E>> getPagedResult();
